...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-neutral-800 bg-[radial-gradient(#cbd5e1_0.5px,transparent_0.5px)] bg-[length:24px_24px]">
      {/* Navigation */}
      <nav className="bg-white dark:bg-neutral-900/80 backdrop-blur-sm border-b border-slate-200 dark:border-neutral-700/50 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/login"
                className="text-slate-700 dark:text-gray-300 hover:text-slate-900 dark:text-white px-4 py-2 text-sm font-semibold transition-colors"
              >
                Sign in
              </Link>
              <Link
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <Link
              href="/login"
              className="bg-white dark:bg-neutral-900 text-slate-700 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-neutral-700 dark:bg-neutral-800 px-10 py-4 rounded-xl text-lg font-bold border-2 border-slate-200 dark:border-neutral-700 transition-all"
            >
              Sign In
            </Link>
          </div>
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap justify-center gap-8 text-sm text-slate-600 dark:text-gray-400 dark:text-gray-400">
        ...
        <section className="py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-sm p-8 border border-slate-200 dark:border-neutral-700/50 hover:shadow-lg transition-shadow">
        ...
        {/* Stats Section */}
        <section className="py-24">
          <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-xl p-12 border border-slate-200 dark:border-neutral-700/50">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div>
                <div className="text-5xl font-black text-blue-700 mb-3">200+</div>
                <div className="text-slate-600 dark:text-gray-400 font-semibold">Practice Questions</div>
                <p className="text-sm text-slate-600 dark:text-gray-400 dark:text-gray-400 mt-2">Expertly crafted and reviewed</p>
              </div>
              <div>
                <div className="text-5xl font-black text-blue-700 mb-3">50+</div>
                <div className="text-slate-600 dark:text-gray-400 font-semibold">Sub-Topics Covered</div>
                <p className="text-sm text-slate-600 dark:text-gray-400 dark:text-gray-400 mt-2">Comprehensive content library</p>
              </div>
              <div>
                <div className="text-5xl font-black text-blue-700 mb-3">100%</div>
                <div className="text-slate-600 dark:text-gray-400 font-semibold">NMLS Compliant</div>
                <p className="text-sm text-slate-600 dark:text-gray-400 dark:text-gray-400 mt-2">Always up-to-date standards</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24">
          <div className="bg-gradient-to-br from-blue-700 to-blue-900 rounded-2xl shadow-2xl p-16 text-center text-white">
            ...
            <Link
              href="/register"
              className="bg-white dark:bg-neutral-900 text-blue-700 hover:bg-blue-50 px-10 py-4 rounded-xl text-lg font-bold shadow-lg inline-flex items-center gap-3 transition-all"
            >
      ...
      {/* Footer */}
      <footer className="bg-white dark:bg-neutral-900 border-t border-slate-200 dark:border-neutral-700 mt-24">
