          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            <div className="flex gap-12 text-center">
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900 dark:text-white">{weeklyGoal}%</p>
              </div>
              <div>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Study Streak</p>
                <p className="text-2xl font-bold text-slate-900 dark:text-white">{studyStreak} Days</p>
              </div>
              <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-4 py-2 bg-blue-50 text-blue-700 text-xs font-bold rounded-full border border-blue-100 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-800">
                    TILA Disclosures
                  </span>
                  <span className="px-4 py-2 bg-blue-50 text-blue-700 text-xs font-bold rounded-full border border-blue-100 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-800">
                    APR Calculation
                  </span>
                  <span className="px-4 py-2 bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-xs font-bold rounded-full border border-slate-200 dark:border-slate-700">
                    Privacy Act
                  </span>
                  <span className="px-4 py-2 bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-xs font-bold rounded-full border border-slate-200 dark:border-slate-700">
                    Escrow Rules
              ...
              <div className="p-4 bg-indigo-50/50 rounded-xl border border-indigo-100 dark:bg-indigo-900/20 dark:border-indigo-800">
                <div className="flex items-start gap-3">
                  <Lightbulb className="w-5 h-5 text-indigo-500 dark:text-indigo-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-sm font-bold text-indigo-900 dark:text-indigo-100 mb-1">Learning Insight</p>
